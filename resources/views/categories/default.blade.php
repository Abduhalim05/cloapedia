    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <h2><i class="fa fa-leaf bg-aqua"></i> {{$category->name}} <small class="hidden-xs-down hidden-sm-down">Nulla felis eros, varius sit amet volutpat non. </small></h2>
            </div><!-- end col -->
                    ...
                    <div class="blog-custom-build">
                        ...
                        <div class="blog-box">
                            ...
                            <div class="blog-meta big-meta text-center">
                                ...
                                <small><a href="/category/{{strtolower($category->name)}}" title="">{{$category->name}}</a></small>
