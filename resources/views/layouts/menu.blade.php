        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6 hidden-xs-down">
                <div class="topsocial">
                    ...
                    <a href="https://www.flickr.com/" data-toggle="tooltip" data-placement="bottom" title="Flickr"><i class="fa fa-flickr"></i></a>
            ...
            <div class="collapse navbar-collapse justify-content-md-center" id="cloapediamenu">
                <ul class="navbar-nav">
                    ...
                    @foreach ($menus as $menu )
                        ...
                        <li class="nav-item">
                            <a class="nav-link color-{{$rand_color}}-hover @if (\Request::route()->slug=='{{$menu->category->slug}}') active @endif" href="{{route('category', $menu->category->slug)}}">{{$menu->name}}</a>
                        </li>
